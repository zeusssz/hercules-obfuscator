...
function Compressor.process(code)
    ...
    code = code:gsub("%.%.", "..")
    code = joinLines(code)
    code = code:gsub(keywordToken("do") .. ";", keywordToken("do") .. " ")
    code = code:gsub(keywordToken("then") .. ";", keywordToken("then") .. " ")
    code = code:gsub(keywordToken("else") .. ";", keywordToken("else") .. " ")
    code = code:gsub(keywordToken("repeat") .. ";", keywordToken("repeat") .. " ")
    code = code:gsub(keywordToken("function") .. ";", keywordToken("function") .. " ")
    ...
    code = code:gsub("else;", "else ")
    code = code:gsub("repeat;", "repeat ")
