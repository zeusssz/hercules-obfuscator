...
manifest.modules = {
    ...
    {
        key = "constant_encoding",
        config_key = "constant_encoding",
        name = "Constant Encoding",
        module = "modules/constant_encoder",
        enabled = true,
        bit_position = 13,
        pipeline_order = 35,
        cli = { short = "-ce", long = "--constant_encoding" },
        incompatible_with = {},
        description = "Enable numeric and primitive constant encoding",
    },
    {
